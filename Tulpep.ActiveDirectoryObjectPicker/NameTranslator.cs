...
namespace Tulpep.ActiveDirectoryObjectPicker
{
	...
	{
		private const int NameTypeNt4 = (int)ADS_NAME_TYPE_ENUM.ADS_NAME_TYPE_NT4;
		private const int NameTypeUpn = (int)ADS_NAME_TYPE_ENUM.ADS_NAME_TYPE_USER_PRINCIPAL_NAME;
