namespace ADPickerTester
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chklistDefaultTypes.TabIndex = 6;
			// 
			// label1
			// 
			...
			this.chklistAllowedTypes.TabIndex = 2;
			// 
			// label3
			// 
			...
			this.chklistAllowedLocations.TabIndex = 4;
			// 
			// label4
			// 
			...
			this.chklistDefaultLocations.TabIndex = 8;
			// 
			// chkShowAdvanced
			// 
			...
			this.chkShowAdvanced.TabIndex = 18;
			this.chkShowAdvanced.Text = "Show Advanced";
			this.chkShowAdvanced.UseVisualStyleBackColor = true;
			// 
			// txtTargetComputer
			// 
			this.txtTargetComputer.Location = new System.Drawing.Point(104, 163);
			this.txtTargetComputer.Name = "txtTargetComputer";
			this.txtTargetComputer.Size = new System.Drawing.Size(154, 20);
			...
			this.chklistAttributes.TabIndex = 10;
			// 
			// label6
			// 
			...
			this.chkSkipDcCheck.TabIndex = 17;
			...
			this.comboPathProvider.TabIndex = 21;
			// 
			// label7
			// 
			...
			// txUserName
			// 
			this.txUserName.Location = new System.Drawing.Point(47, 190);
			this.txUserName.Name = "txUserName";
			this.txUserName.Size = new System.Drawing.Size(85, 20);
			this.txUserName.TabIndex = 14;
			// 
			// label9
			// 
			...
			// txPassword
			// 
			this.txPassword.Location = new System.Drawing.Point(173, 190);
			this.txPassword.Name = "txPassword";
			this.txPassword.Size = new System.Drawing.Size(85, 20);
